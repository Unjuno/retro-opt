...
METAL_PROBABILITIES = (0.01, 0.05, 0.10, 0.20)
...
def run() -> dict[str, object]:
    ...
    for current_exp in CURRENT_EXP_VALUES:
        for metal_probability in METAL_PROBABILITIES:
    ...
    return {
        ...
        "normal_outcome_assumption": (
            "conditional on non-metal, listed values are treated as equally likely "
